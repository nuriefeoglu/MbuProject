...
public class DarcyWeisbachMethodPresenter {

    private IView view;
    private List<Double> pipesArr = new ArrayList<>();

    DarcyWeisbachMethodPresenter(IView view) {
    ...
    private void calculate() {
        ...
        try {
            Double result = Formulas.darcyWeisbachMethod(pipesArr.get(0), pipesArr.get(1), pipesArr.get(2), pipesArr.get(3));
