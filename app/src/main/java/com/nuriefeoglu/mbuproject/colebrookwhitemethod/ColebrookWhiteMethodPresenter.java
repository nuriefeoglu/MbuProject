...
public class ColebrookWhiteMethodPresenter {

    private IView view;
    private List<Double> pipesArr = new ArrayList<>();

    ColebrookWhiteMethodPresenter(IView view) {
        this.view = view;
    }
    ...
    private void calculate() {
        ...
        try {
            Double result = Formulas.colebrookWhiteMethod(pipesArr.get(0), pipesArr.get(1), pipesArr.get(2));
